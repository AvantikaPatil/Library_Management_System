...
public class Lendbook extends javax.swing.JFrame {
    ...
    public void Issuebook_Load(){
        int c;
        try {
            pst = (PreparedStatement) con.prepareStatement("Select i.id, i.memberid, m.name, b.bname, i.issuedate, i.returndate from issued_book i JOIN member m on i.memberid = m.id JOIN book b on i.bookid = b.id");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "MemberID", "Member Name", "Book", "Date", "ReturnDate"
            }
        ) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtid)
                            .addComponent(txtbook, 0, 222, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into issued_book(memberid, membername, bookid, issuedate, returndate)values(?, ?, ?, ?, ?)");
            pst.setString(1, mid);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("update issued_book set memberid = ?, bookid = ?, issuedate = ?, returndate = ? where id = ?");          
            pst.setString(1, mid);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("Delete from issued_book where id = ?");
            pst.setInt(1, id);
            int k = pst.executeUpdate();
