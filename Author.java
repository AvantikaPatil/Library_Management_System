...
public class Author extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into author(name, address)values(?, ?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("update author set name = ?, address = ? where id = ?");
            pst.setString(1, name);
            pst.setString(2, address);
            pst.setInt(4, id);
            int k = pst.executeUpdate();
